...
module disk_with_zones_bottom(r, h, z0=0) {
...
module disk_with_zones_top(r, h, z0=0, disk_index=0) {
  color(gray_disk) translate([0,0,z0]) cylinder(r=r, h=h);
...
module disk_assembly(i) {
  ...
  union() {
    ...
    rotate([0,0,bottom_rot_deg]) {
      disk_with_zones_bottom(bottom_r, token_bottom_h, 0);
    ...
    rotate([0,0,top_rot_for_disk(i)]) {
      disk_with_zones_top(top_r, token_top_h, token_bottom_h, i);
      top_disk_line(top_r);
