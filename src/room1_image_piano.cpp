...
// Deterministic MAC from eFuse (avoid duplicates)
...
static void setupEthernet() {
  ...
  if (Ethernet.begin(MAC) == 0) {
    IPAddress ip(192,168,4,50), dns(192,168,4,1), gw(192,168,4,1), sn(255,255,255,0);
...
void loop() {
  ...
  // TODO: FSMs for image & piano riddles; publish SOLVED on topic_evt
}
