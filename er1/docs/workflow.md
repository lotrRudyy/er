...
er/
  ...
  shared/
    pc-scripts/        # PowerShell and deployment tooling
      ...
      push.sh
      reset_repo.sh
    libs/              # Reserved shared C++ code
    docs/              # Cross-ER documentation
```

`shared/pc-scripts` is the single source of truth for all developer-side tools.
...
All logs originate from `/home/rudyy/er1/scripts/mqtt-logs.sh`.
