...
static constexpr int   CAND_DEBOUNCE_MS = 15;      // debounce candidate triggers
static constexpr uint32_t NOTE_DEBOUNCE_MS = 30;   // debounce only after ACCEPTED notes
...
// Feature ("post", locked)
static constexpr int   FEAT_SEG_MS = 100;
